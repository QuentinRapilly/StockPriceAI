from TransformerStock import TransformerStock
from TransformerStock import generate_square_subsequent_mask
...
# Init of the model
model = TransformerStock(config["model"]["input_size"],
